(function() {
	...
	angular
	.module('nvtApp')
	.controller('ProlongRealEstateController', ['$scope', '$rootScope', '$state', '_',
		'RealEstateResource', '$stateParams', '$log', '$window','toastr',  '$localStorage',
		function($scope, $rootScope, $state, _, RealEstateResource, $stateParams, $log, $window,
				toastr, $localStorage) {
		...
		RealEstateResource.prolong(realEstate)
		.then(function(items) {
			...
			toastr.success('Produzili ste nekretninu!');
		})
